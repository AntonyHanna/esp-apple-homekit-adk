...
// Information Service, the Pairing service and finally the service signature exposed by the heater cooler.
...
#define KIID_HeaterCooler								((uint64_t) 0x0030)
#define kIID_HeaterCoolerServiceSignature				((uint64_t) 0x0031)
#define kIID_HeaterCoolerName							((uint64_t) 0x0032)
#define kIID_HeaterCoolerActive							((uint64_t) 0x0033)
#define kIID_HeaterCoolerCurrentTemperature				((uint64_t) 0x0034)
#define kIID_HeaterCoolerCurrentHeaterCoolerState		((uint64_t) 0x0035)
#define kIID_HeaterCoolerTargetState					((uint64_t) 0x0036)
#define kIID_HeaterCoolerCoolingThresholdTemperature	((uint64_t) 0x0037)
#define kIID_HeaterCoolerHeatingThresholdTemperature	((uint64_t) 0x0038)
...
/**
 * The 'Service Signature' characteristic of the Heater Cooler service.
 */
...
/**
 * The 'Name' characteristic of the Heater Cooler service.
 */
