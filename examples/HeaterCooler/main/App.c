...
typedef struct {
    struct {
		...
		uint8_t targetHeaterCoolerState;
...
HAPError HandleHeaterCoolerActiveRead(
	...
	*value = accessoryConfiguration.state.isActive;
...
HAPError HandleHeaterCoolerCoolingThresholdTemperatureRead(
        ...
        float* value,
        void* _Nullable context) {
	*value = accessoryConfiguration.state.coolingThresholdTemperature;
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, *value ? "true" : "false");
...
HAPError HandleHeaterCoolerHeatingThresholdTemperatureRead(
        ...
        float* value,
        void* _Nullable context) {
	*value = accessoryConfiguration.state.heatingThresholdTemperature;
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, *value ? "true" : "false");
...
HAPError HandleHeaterCoolerActiveWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
	if(accessoryConfiguration.state.isActive != value) {
		accessoryConfiguration.state.isActive = value;
...
HAPError HandleHeaterCoolerCurrentStateWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
	if(accessoryConfiguration.state.currentHeaterCoolerState != value) {
		accessoryConfiguration.state.currentHeaterCoolerState = value;
...
HAPError HandleHeaterCoolerTargetStateWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
	if(accessoryConfiguration.state.targetHeaterCoolerState != value) {
		accessoryConfiguration.state.targetHeaterCoolerState = value;
...
HAPError HandleHeaterCoolerCoolingThresholdTemperatureWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
	if(accessoryConfiguration.state.coolingThresholdTemperature != value) {
		accessoryConfiguration.state.coolingThresholdTemperature = value;
...
HAPError HandleHeaterCoolerHeatingThresholdTemperatureWrite(
        ...
        void* _Nullable context HAP_UNUSED) {
	HAPLogInfo(&kHAPLog_Default, "%s: %s", __func__, value ? "true" : "false");
	if(accessoryConfiguration.state.heatingThresholdTemperature != value) {
		accessoryConfiguration.state.heatingThresholdTemperature = value;
